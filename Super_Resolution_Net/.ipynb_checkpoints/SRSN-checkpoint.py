...
def process_and_train_load_data():
    ...
    trainloader=torch.utils.data.DataLoader(dataset=data_train, batch_size=30, shuffle=True)
    testloader=torch.utils.data.DataLoader(dataset=data_test, batch_size=30, shuffle=True)
